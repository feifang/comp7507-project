var drawChart = function(hierarchy) {

    var zeros = _.map(periods, function(p) {
      return 0.0;
    });
    ...
    var chart = function(d3) {
            ...
            var chart = {},
                ...
                g = 550 - rect.left - rect.right,
                h = 400 - rect.top - rect.bottom,
                i = months,
                j = d3.scale.linear().range([0, g]), //scaleLinear() in v4
...
//                .tickFormat(d3.format(".0f"))
    ...
    var t = function(a, b) {
        ...
        // Data initialization (values, shapes, colors, etc) here
        proficiencydata = d3
        .layout
        .partition()
        .sort(null)
